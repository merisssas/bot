...
func TestNewTask(t *testing.T) {
	...
	task := NewTask("test-id", urls, flags, "", stor, storPath, nil, false, 0, false)
...
func TestNewTaskWithoutFlags(t *testing.T) {
	...
	task := NewTask("test-id-2", urls, flags, "", stor, storPath, nil, false, 0, false)
...
func TestTaskTitle(t *testing.T) {
	...
	task1 := NewTask("id1", []string{"https://example.com/video"}, nil, "", stor, "path", nil, false, 0, false)
	title1 := task1.Title()
	if title1 == "" {
	...
	task2 := NewTask("id2", []string{"https://example.com/v1", "https://example.com/v2"}, nil, "", stor, "path", nil, false, 0, false)
	title2 := task2.Title()
	if title2 == "" {
		t.Error("Task title should not be empty")
	}
...
func TestTaskType(t *testing.T) {
	stor := &MockStorage{}
	task := NewTask("id", []string{"https://example.com"}, nil, "", stor, "path", nil, false, 0, false)
...
func TestTaskID(t *testing.T) {
	...
	task := NewTask(expectedID, []string{"https://example.com"}, nil, "", stor, "path", nil, false, 0, false)
