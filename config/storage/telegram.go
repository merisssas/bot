...
type TelegramStorageConfig struct {
	...
	MaxUploadSizeMB int64 `toml:"max_upload_size_mb" mapstructure:"max_upload_size_mb" json:"max_upload_size_mb"` // override Telegram upload limit (MB), e.g. 4000 for Premium
